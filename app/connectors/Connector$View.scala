...
import config.{AmlsNotificationConfig, MicroserviceAuditConnector, WSHttp}
...
trait Connector$View extends HttpResponseHelper {
...
object Connector$View extends ViewNotificationConnector {

  // $COVERAGE-OFF$
  override private[connectors] lazy val baseUrl: String = AmlsNotificationConfig.desUrl
  override private[connectors] lazy val token: String = s"Bearer ${AmlsNotificationConfig.desToken}"
  override private[connectors] lazy val env: String = AmlsNotificationConfig.desEnv
