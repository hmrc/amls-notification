    ...
    "read json successfully" when {
      "status and status reason is Rejected" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "06", "status_reason" -> "03"),
          "contact_type"   -> "REJR",
      ...
      "fail when length of name exceed maxLength" in {
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsError(List((JsPath \ "name", List(JsonValidationError(List("error.pattern"))))))
        )
      }
      ...
      "fail when length of email exceed maxLength and status type is invalid" in {
        ...
        val json = Json.obj(
          ...
          "status"         -> Json.obj("status_type" -> "03", "status_reason" -> "03"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
      ...
      "fail when length of safeId exceed maxLength" in {
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsError(List((JsPath \ "safeId", List(JsonValidationError(List("error.pattern"))))))
        )
      }
      ...
      "fail when status type is valid Rejected type and status reason is invalid rejected reason" in {
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsError(List((JsPath \ "status" \ "status_reason", List(JsonValidationError(List("error.invalid"))))))
        )
      }
      ...
      "fail when status type is valid Deregistered type and status reason is invalid Deregistered reason" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "08", "status_reason" -> "100"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
      ...
      "fail when status type is valid Revoked type and status reason is invalid Revoked reason" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "10", "status_reason" -> "100"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
      ...
      "fail when status type is invalid and status reason is invalid" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "100", "status_reason" -> "100"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsError(List((JsPath \ "status" \ "status_type", List(JsonValidationError(List("error.invalid"))))))
        )
      }
      ...
      "status and status reason is Revoked" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "08", "status_reason" -> "02"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
      ...
      "status and status reason is DeRegistered" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "10", "status_reason" -> "01"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
      ...
      "status and status reason is Expired" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "11", "status_reason" -> "03"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsSuccess(
            NotificationPushRequest(
              ...
              "test",
              "test@gg.com",
              Some(Status(StatusType.Expired, None)),
              Some(ContactType.RejectionReasons),
              Some("112345678251212"),
              variation = false
            )
      ...
      "status and status reason is Approved" in {
        ...
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "04", "status_reason" -> "03"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
        ...
        NotificationPushRequest.jsonReads.reads(json) must be(
          JsSuccess(
            NotificationPushRequest(
              ...
              "test",
              "test@gg.com",
              Some(Status(StatusType.Approved, None)),
              Some(ContactType.RejectionReasons),
              Some("112345678251212"),
              variation = false
            )
    ...
    "fail serialization" when {
      "status value passed incorrectly" in {
        val json = Json.obj(
          ...
          "name"           -> "test",
          "email"          -> "test@gg.com",
          "status"         -> Json.obj("status_type" -> "7774", "status_reason" -> "03"),
          "contact_type"   -> "REJR",
          "contact_number" -> "112345678251212",
          "variation"      -> false
        )
